...
c =salesArray[salesArray >100]

print(c)

## Step 4: Print the total sales for each register.
print("-----------------------------------------------   STEP FOUR   -----------------------------------------------")
d = salesArray.sum(axis = 1)
print(d)
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
e = salesArray*0.02 #2% fees for every sale
f = e.sum()
...
print("-----------------------------------------------   STEP SEVEN  -----------------------------------------------")
sales_2_and_4_register = salesArray[[1,3]]

print(sales_2_and_4_register)
...
g = np.vstack((salesArray, newRegister))
print(g)
